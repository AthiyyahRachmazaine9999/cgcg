                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align:left;">:
                                {{\Carbon\Carbon::parse($pay_dtl->created_at)->format('d-M-Y')}}</td>
                        </tr>
                        <tr>
                            <th>No.</th>
                            <td>:
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;background-color: yellow;"><b> Due Date: </b>
                                    {{\Carbon\Carbon::parse($pay_dtl->to_date)->format('d-m-Y')}}
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div id="paraf" class="">
                <table id="paraf_tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="padding-top:50px; text-align:center">
                                ...
                                @endphp
                                <img
                                    src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(50)->generate($text))!!} ">
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td style="padding-top:50px text-align:center">Nurul Aryani</td>
                        </tr>
                        @else
                        <tr>
                ...
                <table id="payment">
                    <tbody>
                        <tr>
                            <th>No. Date</th>
                            <td style="text-align:left;">:
                                {{\Carbon\Carbon::parse($pay_dtl1->created_at)->format('d-M-Y')}}</td>
                        </tr>
                        <tr>
                            <th>No.</th>
                            <td>:
                    ...
                    <table id="payment2">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;background-color: yellow;"><b> Due Date: </b>
                                    {{\Carbon\Carbon::parse($pay_dtl1->to_date)->format('d-m-Y')}}
                                </td>
                            </tr>
                        </tbody>
                    </table>
