...
<body>
    ...
    <main>
        ...
        <table class="table table-sm table-borderless mb-0" style="width:100%; padding-top:5px">
            <tbody>
                <tr>
                    <th class="pl-0 w-25 text-left" scope="row">Nama
                    </th>
                    <td>: {{emp_name($main->emp_id)}}</td>
                    <th class="pl-0 w-25 text-right" scope="row">Tanggal Diajukan
                    </th>
                    <td>: {{Carbon\Carbon::parse($main->tgl_pengajuan)->format('d F Y')}}</td>
                </tr>
            </tbody>
        </table>
        <table id="set_customers" style="padding-top: 20px;">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    <td>{{$j++}}</td>
                    <td>{{\Carbon\Carbon::parse($dtl->tgl_pekerjaan)->format('d F Y')}}</td>
                    <td class="text-left">{{$dtl->deskripsi}}</td>
            ...
            <tfoot>
                <tr>
                    <td colspan="3" class="font-weight-bold text-center"><b>{{terbilang($total)}}</b>
                    </td>
