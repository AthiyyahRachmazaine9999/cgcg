    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('vendor_name','',['id'=>'vendor_name','class'=>'form-control','placeholder'=>'Masukkan Nama Perusahaan / Dinas','required']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                {!! Form::label('pic_phone', 'Phone ', ['class' => 'col-lg-3 col-form-label']) !!}
                <div class="col-lg-7">
            ...
            <div class="text-right">
                ...
                <button type="submit" class="btn btn-primary">Create Vendor<i class="far fa-save ml-2"></i></button>
            </div>
