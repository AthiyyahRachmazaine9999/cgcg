    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('vendor_name',$data->vendor_name,['id'=>'vendor_name','class'=>'form-control','placeholder'=>'Masukkan Nama Perusahaan / Dinas','required']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            {!! Form::select('city', $city, $data->city,['id' => 'city', 'class' => 'form-control form-control-select2', 'placeholder' => 'Pilih Kota','required']) !!}
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            {!! Form::select('country', $country, $data->country,['id' => 'country', 'class' => 'form-control form-control-select2', 'placeholder' => 'Pilih Provinsi']) !!}
                        </div>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::hidden('id_pic[]',$val->id,['id'=>'name','class'=>'form-control','placeholder'=>'Masukkan Nama PIC','required']) !!}
                    {!! Form::text('name[]',$val->name,['id'=>'name','class'=>'form-control','placeholder'=>'Masukkan Nama PIC','required']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('position[]',$val->position,['id'=>'position','class'=>'form-control','placeholder'=>'Masukan Jabatan','required']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('pic_phone[]',$val->pic_phone,['id'=>'pic_phone','class'=>'form-control','placeholder'=>'Masukan Nomer HP']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::email('pic_email[]',$val->pic_email,['id'=>'pic_email','class'=>'form-control','placeholder'=>'Masukan Email','required']) !!}
                </div>
            </div>
            ...
            <div class="text-right">
                {!! Form::button('Cancel', ['class' => 'btn btn-danger btn-cancel', 'data-method' => 'sales/vendor', 'type' => 'button','onclick'=>'cancel(this)']) !!}
