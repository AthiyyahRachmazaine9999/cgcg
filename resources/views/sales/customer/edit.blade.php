        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            {!! Form::select('country', $country, $data->country,['id' => 'country', 'class' => 'form-control form-control-select2', 'placeholder' => 'Pilih Provinsi','required']) !!}
                        </div>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('jabatan[]',$val->jabatan,['id'=>'jabatan','class'=>'form-control','placeholder'=>'Masukan Jabatan','required']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('mobile[]',$val->mobile,['id'=>'mobile','class'=>'form-control','placeholder'=>'Masukan Nomer HP']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::email('email_pic[]',$val->email,['id'=>'email_pic','class'=>'form-control','placeholder'=>'Masukan Email','required']) !!}
                </div>
            </div>
            ...
            <div class="text-right">
                {!! Form::button('Cancel', ['class' => 'btn btn-danger btn-cancel', 'data-method' => 'sales/customer', 'type' => 'button','onclick'=>'cancel(this)']) !!}
                <button type="submit" class="btn btn-primary">Update Customer<i class="far fa-save ml-2"></i></button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
