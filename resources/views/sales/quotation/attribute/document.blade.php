...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        {!! Form::date('waktu_pelaksanaan', '', ['id'=>'waktu_pelaksanaan','class' => 'form-control','placeholder' => 'Masukkan Batas Akhir']) !!}
    </div>
</div>
<div class="row mt-3">
    <div class="col-md-6">
...
<div class="row mt-3">
    <div class="col-md-6">
        ...
        {!! Form::text('no_fakturpajak','' , ['id'=>'no_fakturpajak','class' => 'form-control','placeholder' => 'Masukkan No Faktur Pajak']) !!}
    </div>
    <div class="col-md-6">
...
<div class="row mt-3">
    <div class="col-md-6">
        ...
        {!! Form::text('no_fakturjual','' , ['id'=>'no_fakturjual','class' => 'form-control','placeholder' => 'Masukkan No Faktur Penjualan']) !!}
    </div>
    <div class="col-md-6">
