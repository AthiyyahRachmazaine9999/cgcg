    ...
    <tr>
        ...
        <td class="text-right">
            <h5 class="text-danger">
                <strong>
                    @php
                    $grossm = $subtotal_order == 0 ? 0 : ($margin/$invoice_price)*100;
                    echo round($grossm,2).' %';
                    @endphp
                </strong>
            </h5>
    ...
    <tr>
        ...
        <td class="text-right">
            <h5 class="text-danger">
                <strong>
                    @php
                    echo $subtotal_order == 0 ? 0 : round(($sp_margin/$invoice_price)*100,2).' %';
                    @endphp
                </strong>
            </h5>
        </td>
        ...
        <tr>
            ...
            <td class="text-right">
                <h5 class="text-danger">
                    <strong>
                        @php
                        echo $subtotal_order == 0 ? 0 : round((($net_margin)/$invoice_price)*100,2). " %";
                        @endphp
                    </strong>
                </h5>
            </td>
...
<div class="card-footer bg-white text-right">
    ...
    @if(getUserEmp(Auth::id())->division_id=='10')
    <button type="button" data-id="{{$main->id}}" onclick="SiapKirim(this)" class="btn btn-warning btn-labeled btn-labeled-left legitRipple"><b><i class="icon-truck"></i></b> Siap Kirim</button>
    @endif
    @php }else{ @endphp
