            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::label('id_customer', 'Customer *', ['class' => 'col-form-label']) !!}
                        @if($visit!=null)
                        {!!Form::text('name_customer',getCustomer($visit->id_customer)->company,['id'=>'ids','class'=>'form-control','placeholder'=>'*','readonly'])
                        !!}
                        {!!Form::hidden('id_customer',$visit->id_customer,['id'=>'ids','class'=>'form-control','placeholder'=>'*','readonly'])
                        !!}
                        @else
