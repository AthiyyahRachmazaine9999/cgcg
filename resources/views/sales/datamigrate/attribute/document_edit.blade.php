...
<div class="row mt-3">
    <div class="col-md-4">
        ...
        {!! Form::text('quo_no',$utama->quo_no , ['id'=>'quo_no','class' => 'form-control',
        'placeholder' => 'Masukkan No PO','readonly']) !!}
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4 mt-4">
        <button type="button" id="uploadpo" data-toggle="modal" data-target="#m_modal3" data-type="po"
            data-id="{{$main->id_quo}}" data-po="{{$main->doc_po}}" onclick="up_Migrate_doc(this)"
            class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                <i class="far fa-save ml-2"></i></b>Upload File</button>
        @if($main->doc_po!=null)
...
<div class="row mt-3">
    ...
    <div class="col-md-4 mt-4">
        <button type="button" id="uploadsp" data-toggle="modal" data-target="#m_modal3" data-type="sp"
            data-id="{{$main->id_quo}}" data-sp="{{$main->doc_sp}}" onclick="up_Migrate_doc(this)"
            class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                <i class="far fa-save ml-2"></i></b>Upload File</button>
        @if($main->doc_sp!=null)
...
<div class="row mt-3">
    <div class="col-md-4">
        ...
        {!! Form::text('no_spk',$main->no_spk , ['id'=>'no_spk','class' => 'form-control',
    ...
    <div class="col-md-4 mt-3">
        <button type="button" id="uploadspk" data-toggle="modal" data-target="#m_modal3" data-type="spk"
            data-id="{{$main->id_quo}}" data-spk="{{$main->doc_spk}}" onclick="up_Migrate_doc(this)"
            class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                <i class="far fa-save ml-2"></i></b>Upload File</button>
...
<div class="row mt-3">
    <div class="col-md-4">
        ...
        {!! Form::text('no_bast',$main->no_bast , ['id'=>'no_bast','class' => 'form-control',
    ...
    <div class="col-md-4 mt-3">
        <button type="button" id="uploadbast" data-toggle="modal" data-target="#m_modal3" data-type="bast"
            data-id="{{$main->id_quo}}" data-value="{{$main->doc_bast}}" onclick="up_Migrate_doc(this)"
            class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                <i class="far fa-save ml-2"></i></b>Upload File</button>
...
<div class="row mt-3">
    ...
    <div class="col-md-4 mt-3">
        <button type="button" id="uploadfp" data-toggle="modal" data-target="#m_modal3" data-type="fakturpajak"
            data-id="{{$main->id_quo}}" data-value="{{$main->doc_fakturpajak}}" onclick="up_Migrate_doc(this)"
            class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                <i class="far fa-save ml-2"></i></b>Upload File</button>
...
<div class="row mt-3">
    ...
    <div class="col-md-4 mt-3">
        <button type="button" id="uploadfj" data-toggle="modal" data-target="#m_modal3" data-type="fakturjual"
            data-id="{{$main->id_quo}}" data-value="{{$main->doc_fakturjual}}" onclick="up_Migrate_doc(this)"
            class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                <i class="far fa-save ml-2"></i></b>Upload File</button>
