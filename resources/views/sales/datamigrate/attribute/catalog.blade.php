<div class="nav-tabs-responsive bg-light border-top">
    <ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
        <li class="nav-item"><a href="#info" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i>
                Info Utama</a></li>
        <li class="nav-item"><a href="#doc" class="nav-link" data-toggle="tab"><i class="icon-archive mr-2"></i>
                Kelengkapan Dokumen</a></li>
        <li class="nav-item"><a href="#invoice" class="nav-link" data-toggle="tab"><i
                    class="icon-credit-card2 mr-2"></i> Invoicing</a></li>
    </ul>
</div>
<div class="tab-content">
                        ...
                        <td class="font-weight-bold">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    Kondisi :
                                    @php
                                    if (!empty( $main->quo_approve_status)) {echo ucfirst($main->quo_approve_status);}
                                    else{echo $main->quo_ekskondisi;}
                                    @endphp<br>
                                </div>
                                <div class="col-lg-4">
                                    <button type="button" data-toggle="modal" data-target="#m_modal"
                                        data-id="{{$main->id}}" onclick="EditStatus(this)"
                                        class="btn btn-success btn-labeled btn-labeled-left btn-sm legitRipple pull-right"><b><i
                                                class="icon-pencil5"></i></b> Ubah</button>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="tab-pane" id="doc">
        <div class="row">
            <div class="col-lg-12">
                @php
                if(Session::get('division_id')=='10' or Session::get('division_id')=='3' or
                Session::get('division_id')=='8'){
                @endphp
                <button type="button" data-toggle="modal" data-target="#m_modal" data-val={{$val}}
                    data-id="{{$main->id}}" onclick="EditDocument(this)" data-lvl="migrate"
                    class="btn btn-success btn-labeled btn-labeled-left btn-sm legitRipple ml-3 mt-3 mb-3"><b><i
                            class="icon-pencil5"></i></b> Tambah / Edit Dokumen</button>
                @php } @endphp
            </div>
        </div>
        <div class="table-responsive">
            <table class="table table-lg">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{asset('public/'.$document->doc_po)}}"
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{asset('public/'.$document->doc_sp)}}"
                                class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                                    <i class="fas fa-cloud-download-alt"></i></b>Download File
                            </a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{asset('public/'.$document->doc_spk)}}"
                                class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                                    <i class="fas fa-cloud-download-alt"></i></b>Download File
                            </a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{asset('public/'.$document->doc_bast)}}"
                                class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                                    <i class="fas fa-cloud-download-alt"></i></b>Download File
                            </a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{asset('public/'.$document->doc_fakturpajak)}}"
                                class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                                    <i class="fas fa-cloud-download-alt"></i></b>Download File
                            </a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{asset('public/'.$document->doc_fakturjual)}}"
                                class="btn btn-primary btn-labeled btn-labeled-left btn-sm legitRipple text-right"><b>
                                    <i class="fas fa-cloud-download-alt"></i></b>Download File
                            </a>
                        </td>
