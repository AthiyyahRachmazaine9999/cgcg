                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    @php
                                    if(is_null(getWarehouse('id_purchase', $val->id_po)) or is_null(getWarehouseDet("id_product",$val->id_product, getWarehouse('id_purchase', $val->id_po)->id))){
                                    $attr = $statusv = $qtyv = "checked";
                                    $statusb = $qtyb = "checked";
                                    $qtyr = $val->qty;
                                    }else{
                                    $attr    = 'checked';
                                    $gets    = getWarehouseDet("id_product",$val->id_product, getWarehouse('id_purchase', $val->id_po)->id);
