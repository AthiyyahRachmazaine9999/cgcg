    ...
    <div class="card">
        <div class="card-header bg-transparent header-elements-inline">
            ...
            <div class="header-elements">
                <button type="button" onclick="PrintFinalPO(this)" data-id="{{$main->po_number}}" class="btn btn-warning btn-sm ml-3"><i class="icon-printer mr-2"></i> Print Copy PO</button>
            </div>
        </div>
                    ...
                    <div class="mb-4 mt-4">
                        <div class="text-sm-right">
                            ...
                            <ul class="list list-unstyled mb-0">
                                ...
                                <li>Nomer Paket: <span class="font-weight-semibold">{!!sprintf("%06d", getQuo($main->id_quo)->quo_no)!!} </span></li>
                            </ul>
                            @php }else {
                ...
                <div class="table-responsive">
                    <table class="table table-lg">
                        ...
                        <tbody>
                            ...
                            $check = $val->id_product!=0 ? getPurchasingQuo($val->id_product)->id_product : getProductQuo($val->id_product)->id_product
                            @endphp
                            <tr>
                                <td class="text-center">
                                    @php
                                    if(is_null(getWarehouseDet("id_product",$val->id_product, $val->id))){
                                    $attr = $statusv = $qtyv = "";
                                    $statusb = $qtyb = "checked";
                                    $qtyr = $val->qty;
                                    }else{
                                    $attr = 'checked';
                                    $gets = getWarehouseDet("id_product",$val->id_product, $val->id);
