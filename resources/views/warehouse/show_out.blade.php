...
<div class="content">
    ...
    <div class="card">
                    ...
                    <div class="mb-4 mt-4">
                        <div class="text-sm-right">
                            ...
                            <ul class="list list-unstyled mb-0">
                                ...
                                <li>Nomer Paket: <span class="font-weight-semibold">{!!getQuo($main->id_quo)->quo_no!!} </span></li>
        ...
        <div class="tab-content">
            @include('warehouse.attribute.tab_barang')
            @include('warehouse.attribute.tab_alamat')
            @include('warehouse.attribute.tab_history')
            @include('warehouse.attribute.tab_resi')
        </div>
...
@endsection
@section('script')
<script src="{{ asset('ctrl/warehouse/wh-detail.js?v=').rand() }}" type="text/javascript"></script>
