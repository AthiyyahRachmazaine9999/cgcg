...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Create Shipping</h5>
        </div>
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('company','',['id'=>'company','class'=>'form-control','placeholder'=>'Masukkan Nama Perusahaan / Vendor','required']) !!}
                </div>
            </div>
            ...
            <div class="text-right">
                ...
                <button type="submit" class="btn btn-primary">Create Shipping<i class="far fa-save ml-2"></i></button>
            </div>
