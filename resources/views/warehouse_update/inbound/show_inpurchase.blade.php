        ...
        <div class="tab-content">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    @php
                                    if(is_null(CheckWhInbound("sku",getProductPo($val->id_product)->sku, $val->id_po,
                                    $val->id_quo))){
                                    $attr = "";
                                    $return = "no";
                                    $qtyr = "";
                                    ...
                                    $gets = CheckWhInbound("sku",getProductPo($val->id_product)->sku, $val->id_po,
                                    $val->no_ref == null ? $val->id_quo : $val->no_ref);
                                    ...
                                    <input name="terima[]" type="checkbox"
                                        value="{!!getProductPo($val->id_product)->sku.$j++!!}"
                                        class="form-check-input-switchery" {!!$attr!!} data-fouc>
                                </td>
                                <td>
                                    <input name="id_dum[]" type="hidden"
                                        value="{!!getProductPo($val->id_product)->sku.$r++!!}" class="form-control">
                                    <input name="id_product[]" type="hidden"
                                        value="{!!getProductPo($val->id_product)->sku!!}" class="form-control">
                                    ...
                                    <p onclick="ScanBarcode(this)" data-dismiss="modal" data-toggle="modal"
                                        ...
                                        data-namebarang="{!!getProductPo($val->id_product)->name!!}" data-po="{{$main->id}}" data-quo="{{$val->id_quo}}" data-type="inbound" data-id_inbound="{{$idwh}}"
                                ...
                                <td class="text-center">
                                    <input name="qty_terima[]" type="number" value="{{$qtyr}}" class="form-control"
            ...
            <div class="tab-pane fade show" id="history">
                <div class="card-body">
                    ...
                    @endif
                    @else
                    <span class="text-danger"><b>History belum Tersedia</b></span>
                    @endif
                </div>
            </div>
        </div>
