        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    ...
                    {!! Form::select('id_emp',$getuser,$data->id_emp,['id'=>'id_emp','class'=>'form-control','placeholder'=>'Pilih Nama Karyawan','required']) !!}
            ...
            <div class="form-group row">
                ...
                {!! Form::label('password', 'New Password *', ['class' => 'col-lg-3 col-form-label']) !!}
