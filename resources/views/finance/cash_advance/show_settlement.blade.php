        ...
        <form action="{{ route('settlement.updates', $cash->id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" id="setts">
                    ...
                    <tbody>
                        @php $total = 0; $p=1; $s=1; $l=1; foreach($set as $dtl) { @endphp
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <a href="{{ asset($dtl->up_files) }}" class="btn btn-outline-primary btn-sm">SHOW</a>
                                @else
                                <a href="{{ asset($dtl->up_files) }}" class="btn btn-outline-primary btn-sm"
                                    disabled>SHOW</a>
                                @endif
                            </td>
                            ...
                            <td>{{number_format($dtl->set_nominal)}}
                            </td>
                        </tr>
