<div class="card-body">
    ...
    <div class="form-group row">
        <label class="col-lg-3 col-form-label form-check-input-styled-primary" value="pro_priceType">Referensi*</label>
        <div class="col-lg-7">
            {!! Form::text('no_ref', $cash->no_cashadv,['id' => 'emps', 'class'
            => 'form-control form-control-select2', 'placeholder' => '*', 'readonly']) !!}
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-7">
            <div class="form-control">{{province($cash->des_provinsi)}} - {{city($cash->des_kota)}}</div>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        <label class="col-lg-3 col-form-label form-check-input-styled-primary" value="pro_priceType">Tanggal Transfer
            Cash Advance</label>
        <div class="col-lg-7">
    ...
    <div class="pros_finance">
        <div class="card-header bg-light text-primary-800 border-bottom-primary header-elements-inline">
            <h6 class="card-title">Proccessed By Finance</h6>
        </div><br>
        <div class="form-group row">
            ...
            <div class="col-lg-7">
                ...
                'class'
                => 'form-control', 'placeholder' => 'Masukkan Note','readonly']) !!}
            </div>
        </div>
...
<div class="tab-content">
    ...
    <br>
        <div class="this_place">
            ...
            $cash->biaya_finance > $total && $set->sisa_biaya==null)
            ...
            <div class="card-body">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                        <td> {{number_format($cash->biaya_finance)}}
                                        </td>
                                        </td>
                                    </tr>
                                    @php $a=0; $a= abs($cash->biaya_finance - $total) @endphp
                                    @if($set->sisa_biaya==$a && $set->sisa_biaya!=null)
                                    <tr>
                                        <th>Pay Back :</th>
                                        <td class="text-right">
                                        <td class="text-primary">{{number_format($set->sisa_biaya)}}</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Status Settlement:</th>
                                        <td class="text-right">
                                        <td>{{number_format($a-$set->sisa_biaya) == 0 ? "ALL DONE" : "-"}}
                                        </td>
                                        </td>
                                    </tr>
                                    @endif
                                    @if($set->biaya_finance==null && $set->sisa_biaya==null)
                                    <tr>
                                        <th>Cost:</th>
                                        <td class="text-right">
                                        <td> {{$set->sisa_biaya==null ? number_format($a) : number_format($a-$set->sisa_biaya)}}
                                        </td>
                                        </td>
                                    </tr>
                                    @endif
                                    @if($set->biaya_finance!=null || $set->biaya_finance!=0)
                                    <tr>
                                        @php $a=0; $a= abs($cash->biaya_finance - $total) @endphp
                                        <th>Proccesed By Finance :
                                        </th>
                                        <td class="text-right">
                                    ...
                                    @endif
                                    @if($set->app_finance!=null && $set->sisa_biaya==null)
                                    <tr>
                                        @php $d=0; $d= abs($a - $set->biaya_finance) @endphp
                                        <th>Status Settlement:</th>
                                        <td class="text-right">
                                        <td>{{number_format($d) == 0 ? "ALL DONE" : "-"}}
                                        </td>
                                        </td>
                                    </tr>
                                    @endif
                ...
                <div class="text-right">
                    ...
                    <button id="approval" name="approval" onClick="set_app(this)" data-user="spv" data-type="approval"
                        data-id="{{$set->id}}" data-user="spv" class="btn btn-primary"><i
                    ...
                    <button id="approval" name="approval" onClick="set_app(this)" data-user="mng" data-type="approval"
                        data-id="{{$set->id}}" data-user="mng" class="btn btn-primary"><i
                            class="fas fa-file"></i>Approve</button>
                    <button id="rem_sub" name="approve" onClick="set_app(this)" data-type="reject" data-id="{{$set->id}}"
