    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('title',$getdata->title,['id'=>'title','class'=>'form-control','placeholder'=>'Enter menu name','required']) !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::select('parent_id', $menu, $getdata->parent_id,['id' => 'parent_id', 'class' => 'form-control form-control-select2', 'placeholder' => '*']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    {!! Form::select('icon_id', $icon, $getdata->icon_id, ['id' => 'icon_id', 'class' => 'form-control','style'=>'width:55%']) !!}
                </div>
                <div class="col-lg-1">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::text('link',$getdata->link,['id'=>'link','class'=>'form-control','placeholder'=>'Enter link menu','required']) !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    {!! Form::textarea('description', $getdata->description, ['id' => 'description', 'class' => 'form-control m-input', 'rows' => 2]) !!}
                </div>
            </div>

            <div class="text-right">
                {!! Form::button('Cancel', ['class' => 'btn btn-danger btn-cancel', 'data-method' => 'setting/menu', 'type' => 'button','onclick'=>'cancel(this)']) !!}
                <button type="submit" class="btn btn-primary">Save Menu<i class="far fa-save ml-2"></i></button>
            </div>
