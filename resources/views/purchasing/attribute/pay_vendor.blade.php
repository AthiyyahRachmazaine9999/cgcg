...
<input type="hidden" name="id_po" value="{{$main->id}}" class="form-control" placeholder='Masukkan Tanggal Pembayaran'
    readonly>
<input type="hidden" name="id_quo" value="{{$main->id_quo}}" class="form-control"
    placeholder='Masukkan Tanggal Pembayaran' readonly>
<input type="hidden" name="id_pay" value="{{$id_pay}}" class="form-control" placeholder='Masukkan Tanggal Pembayaran'
    readonly>
...
<div class="form-group">
    ...
    <input type="text" name="date_payment" id='tanggal' class="form-control" placeholder='Masukkan Tanggal Pembayaran'>
</div>

<div class="form-group">
    {!! Form::label('pays', 'Nominal', ['class' => 'col-form-label']) !!}
    <input type="number" name="pays" id='pays' class="form-control" placeholder='Masukkan Nominal'>
</div>
