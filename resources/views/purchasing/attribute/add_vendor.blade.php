...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        {!! Form::text('vendor_name','',['id'=>'vendor_name','class'=>'form-control','placeholder'=>'Masukkan Nama
        Perusahaan','required']) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        {!! Form::text('phone','',['id'=>'phone','class'=>'form-control','placeholder'=>'Masukan Nomer
        Telpon','required']) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        <div class="row">
            <div class="col-lg-6">
                {!! Form::select('province', $province, null,['id' => 'province', 'class' => 'form-control
                form-control-select2', 'placeholder' => 'Pilih Provinsi','required']) !!}
            </div>
            <div class="col-lg-6">
                {!! Form::select('city', $city, null,['id' => 'city', 'class' => 'form-control form-control-select2',
                'placeholder' => 'Pilih Kota','required', 'disabled']) !!}
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-lg-6">
                {!! Form::select('country', $country, null,['id' => 'country', 'class' => 'form-control
                form-control-select2', 'placeholder' => 'Pilih Provinsi', 'disabled']) !!}
            </div>
        </div>

        <div class="row mt-3">
            <div class="col-lg-12">
                {!! Form::textarea('address','',['id'=>'address','class'=>'form-control','placeholder'=>'Masukan Alamat
                lengkapnya','required']) !!}
            </div>
        </div>
...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        {!! Form::text('position','',['id'=>'position','class'=>'form-control','placeholder'=>'Masukan
        Jabatan','required']) !!}
        {!! Form::hidden('other','yes',['id'=>'other','class'=>'form-control','placeholder'=>'Masukan
        Jabatan','required']) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        {!! Form::email('pic_email','',['id'=>'pic_email','class'=>'form-control','placeholder'=>'Masukan
        Email','required']) !!}
    </div>
</div>

<div class="text-right">
    <button id="simpan_vendor" onClick="save_vendor(this)" class="btn btn-primary">Simpan<i
