    ...
    <div class="card">
                    ...
                    <div class="mb-4 mt-4">
                        <div class="text-sm-right">
                            ...
                            <ul class="list list-unstyled mb-0">
                                ...
                                @endif
                                <li>Referensi: <a href="{{url('sales/quotation').'/'.$main->id_quo}}"><span class="font-weight-semibold">SO{!!sprintf("%06d", getQuo($main->id_quo)->id)!!} </span></a></li>
                            </ul>
                            @php }else {@endphp
        ...
        <div class="nav-tabs-responsive bg-light border-top">
            <ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                ...
                @if($usr->division_id == 3 || $usr->id==10 || $usr->division_id==6)
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="info">
                ...
                <div class="table-responsive">
                    ...
                    <button id="btntambah" type="button" data-id_quo="{{$val->id_quo}}" data-id_po="{{$main->id}}" onClick="add_product(this)" class="ml-3 btn btn-danger btn-sm rounded-round legitRipple pull-right mb-3">
                    ...
                    <div class="d-md-flex flex-md-wrap">
                        ...
                        <div class="pt-2 mb-3 wmin-md-400 ml-auto">
                            ...
                            <div class="text-right mt-3">
                                ...
                                <button type="button" class="btn btn-primary btn-labeled btn-labeled-left" onclick="KirimEmail(this)" data-toggle="modal" data-target="#m_modal" data-id="{{$main->id}}"><b><i class="icon-paperplane"></i></b> Kirim PO</button>
                                @php } else { @endphp
                ...
                <div class="table-responsive">
                    <table class="table table-lg">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{count($pay_dtl)==0?'-' : $paydtl->no_payment}}</td>
