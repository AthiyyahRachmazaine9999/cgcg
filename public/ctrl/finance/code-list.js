    ...
    init: function() {
        ...
        var table = $(".m_datatable").DataTable({
            ...
            ajax: {
                ...
                url: main_url + "finance/list_code",
                type: 'post',
                dataType: 'json',
                data: {
                    '_token': token,
            ...
            columns: [{
                ...
                render: function(data, type, row) {
                    ...
                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; transform: translate3d(-158px, 19px, 0px); top: 0px; left: 0px; will-change: transform;">' +
                        '<a href="' + current_url + '' + data + '/edit" class="dropdown-item"><i class="fas fa-pencil-alt text-primary"></i> Edit</a>' + 
                        '<a href="' + current_url + '' + data + '/delete" class="dropdown-item"><i class="fas fa-trash-alt text-danger"></i> Delete</a>' + '</div></div></div>'
                }
            }, ]
        });
    }
