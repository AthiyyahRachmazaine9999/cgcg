    ...
    init: function() {
        ...
        var table = $(".m_datatable").DataTable({
            ...
            ajax: {
                ...
                url: main_url + "finance/listTaxPph",
                type: 'post',
                dataType: 'json',
                data: {
                    '_token': token,
            ...
            columns: [{
                ...
                return '<div class="list-icons"><div class="dropdown"><a href="#" class="list-icons-item" data-toggle="dropdown" aria-expanded="false"><i class="icon-menu9"></i></a>\
                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; transform: translate3d(-158px, 19px, 0px); top: 0px; left: 0px; will-change: transform;">\
                     <a href="tax/pph/' + data + '/edit" class="dropdown-item"><i class="fas fa-pencil-alt text-primary"></i>Edit</a>\
                     <a href="tax/pph/' + '' + data + '/show" class="dropdown-item"><i class="fas fa-eye"></i>Detail</a>\
                     <a href="tax/' + '' + data + '/delete" class="dropdown-item"><i class="fas fa-trash text-danger"></i>Delete</a>' + '</div ></div ></div >'
                }
            }, ],
        });
    }
